      ...
      plans: [
        {
          ...
          unavailable: ["Smart Quizzes", "Automated Reports", "Retention Tracking", "SortED Days", "Clubs & Events Engine", "Personalized Mentorship"],
        ...
        },
        {
          ...
          unavailable: ["SortED Days", "Clubs & Events Engine", "Personalized Mentorship"],
      ...
      plans: [
        {
          ...
          features: [
            "Payroll Automation",
            "Digital Teaching Records",
            "Leave Management",
            "Basic Attendance Logging",
          ],
          unavailable: ["Standard & Premium Features"],
          buttonText: "Get Started",
          featured: false,
        },
        {
